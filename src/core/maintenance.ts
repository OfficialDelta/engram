...
export function runMaintenance(
	...
	try {
		...
		appendFileSync(
			join(logDir, "maintenance.log"),
			`[${new Date().toISOString()}] maintenance error: ${message}\n`,
		);
